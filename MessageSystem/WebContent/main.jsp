	...
	<body>
				...
				<!-- Banner -->
					<section id="banner" class="major">
						<div class="inner">
							...
							<%} %>
									<!-- 계발 시 바로 보면 오류나서 if문써 사용자 입장에선 오류안나? -->
		...
		<!-- Scripts -->
			...
			<script>
				...
				function idCheck() {
				// 요소의 실제 값을 가지고 오는 방법
				// 1. innerText : 태그 사이에 텍스트를 가지고 오는 방법 <p><span>스마트 </span>그리드</p> ->스마트그리드
				// 2. innerHTML : 태그 사이에 모든 요소를 가지고 오는 방법 <p><span>sp</span></p> -> <span>sp</span>
				// 3. value : input 태그의 value 속성값을 가지고 올때
				...
				*/
				...
				$.ajax({
					...
					url : "IdCheckService", // 데이터를 전송하는 (요청하는) 서퍼페이지 url
