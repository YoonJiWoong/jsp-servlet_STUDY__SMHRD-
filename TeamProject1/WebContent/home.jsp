...
<li class="u-nav-item">ID<input type="text" name="id" placeholder="id를 입력하세요">PW<input type="password" name="pw" placeholder="pw를 입력하세요"><input type="submit" value="로그인"></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Join.html" style="padding: 10px 32px;">회원가입</a></li>
<%}else{ %>

<% if(vo.getId().equals("admin")){  %>
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Logout" style="padding: 10px 32px;">전체 회원정보 삭제</a></li>
							<%} %>


<li><%=vo.getId() %>님 환영합니다.</li>
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Logout" style="padding: 10px 32px;">로그아웃</a></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Update.jsp" style="padding: 10px 32px;">회원정보 수정</a></li>


	<%} %>
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Home.html" style="padding: 10px 32px;">Home</a></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="About.html" style="padding: 10px 32px;">About</a></li>
...
<li>ID<input type="text" name="id">PW<input type="password" name="pw"></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="Home.html" style="padding: 10px 66px;">Home</a></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="About.html" style="padding: 10px 66px;">About</a></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="Join.html" style="padding: 10px 66px;">회원가입</a></li>
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="Join.html"style="padding: 10px 66px;">회원가입</a></li>
</ul>
              </div>
            </div>
      ...
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-sheet-1">
        <div class="u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            ...
            <a href="https://youtu.be/fh4y5dGZX9c"><h5 class="u-align-center u-custom-font u-font-lato u-text u-text-1">추천운동</h5> </a>    
              </div>
            </div>
		...
		C30.68,6.002,30.655,6,30.63,6c-0.164,0-0.328,0.011-0.492,0.014C30.022,6.017,29.913,6.016,29.793,6.021z"></path><path d="M21.793,14h-5c-0.553,0-1,0.447-1,1s0.447,1,1,1h5c0.553,0,1-0.447,1-1S22.346,14,21.793,14z"></path><path d="M21.793,21h-10c-0.553,0-1,0.447-1,1s0.447,1,1,1h10c0.553,0,1-0.447,1-1S22.346,21,21.793,21z"></path><path d="M21.793,28h-15c-0.553,0-1,0.447-1,1s0.447,1,1,1h15c0.553,0,1-0.447,1-1S22.346,28,21.793,28z"></path><path d="M21.793,35h-19c-0.553,0-1,0.447-1,1s0.447,1,1,1h19c0.553,0,1-0.447,1-1S22.346,35,21.793,35z"></path><path d="M21.793,42h-13c-0.553,0-1,0.447-1,1s0.447,1,1,1h13c0.553,0,1-0.447,1-1S22.346,42,21.793,42z"></path><path d="M21.793,49h-7c-0.553,0-1,0.447-1,1s0.447,1,1,1h7c0.553,0,1-0.447,1-1S22.346,49,21.793,49z"></path>
               ...
               <a href="#"><h5 class="u-align-center u-custom-font u-font-lato u-text u-text-3">카운팅</h5></a>
              </div>
            </div>
	...
	"></path></svg></span>
               <a href="Join.html"><h5 class="u-align-center u-custom-font u-font-lato u-text u-text-4">운동랭킹</h5> </a>
              </div>
            </div>
            <div class="u-container-style u-list-item u-palette-1-base u-repeater-item u-video-cover u-list-item-5">
              <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-5"><span class="u-icon u-icon-circle u-icon-5"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 58 58" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-f3ba"></use></svg><svg class="u-svg-content" viewBox="0 0 58 58" x="0px" y="0px" id="svg-f3ba" style="enable-background:new 0 0 58 58;"><g><path d="M42.899,4.5c-0.465-2.279-2.484-4-4.899-4c-0.553,0-1,0.447-1,1s0.447,1,1,1c1.654,0,3,1.346,3,3s-1.346,3-3,3
		...
		s-2.243-5-5-5c-2.414,0-4.434,1.721-4.899,4H0v13v40h58v-40v-13H42.899z M56,55.5H2v-38h54V55.5z"></path><path d="M26,2.5c1.654,0,3,1.346,3,3s-1.346,3-3,3c-0.553,0-1,0.447-1,1s0.447,1,1,1c2.757,0,5-2.243,5-5s-2.243-5-5-5
		c-0.553,0-1,0.447-1,1S25.447,2.5,26,2.5z"></path><path d="M32,2.5c1.654,0,3,1.346,3,3s-1.346,3-3,3c-0.553,0-1,0.447-1,1s0.447,1,1,1c2.757,0,5-2.243,5-5s-2.243-5-5-5
		c-0.553,0-1,0.447-1,1S31.447,2.5,32,2.5z"></path><circle cx="22" cy="24.5" r="1"></circle><circle cx="29" cy="24.5" r="1"></circle><circle cx="36" cy="24.5" r="1"></circle><circle cx="43" cy="24.5" r="1"></circle><circle cx="50" cy="24.5" r="1"></circle><circle cx="8" cy="32.5" r="1"></circle><circle cx="15" cy="32.5" r="1"></circle><circle cx="22" cy="32.5" r="1"></circle><circle cx="29" cy="32.5" r="1"></circle><circle cx="36" cy="32.5" r="1"></circle><circle cx="43" cy="32.5" r="1"></circle><circle cx="50" cy="32.5" r="1"></circle><circle cx="8" cy="39.5" r="1"></circle><circle cx="15" cy="39.5" r="1"></circle><circle cx="22" cy="39.5" r="1"></circle><circle cx="29" cy="39.5" r="1"></circle><circle cx="36" cy="39.5" r="1"></circle><circle cx="43" cy="39.5" r="1"></circle><circle cx="50" cy="39.5" r="1"></circle><circle cx="8" cy="47.5" r="1"></circle><circle cx="15" cy="47.5" r="1"></circle><circle cx="22" cy="47.5" r="1"></circle><circle cx="29" cy="47.5" r="1"></circle><circle cx="36" cy="47.5" r="1"></circle>
</g></svg></span>
               <a href="#"> <h5 class="u-align-center u-custom-font u-font-lato u-text u-text-5">운동달력</h5> </a>
              </div>
            </div>
            <div class="u-container-style u-list-item u-palette-1-base u-repeater-item u-video-cover u-list-item-6">
              <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-6"><span class="u-icon u-icon-circle u-icon-6"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-4e8f"></use></svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 512 512" id="svg-4e8f"><path id="XMLID_208_" d="m157.979 495.227c-1.289 0-2.587-.249-3.825-.762-3.737-1.548-6.173-5.194-6.173-9.239v-65.312c-40.662-11.893-77.261-36.532-103.714-69.979-28.96-36.615-44.267-80.697-44.267-127.481 0-113.413 92.269-205.681 205.682-205.681h100.637c113.412 0 205.681 92.268 205.681 205.681 0 35.029-8.965 69.621-25.925 100.036-2.69 4.823-8.78 6.554-13.604 3.864-4.823-2.69-6.553-8.781-3.863-13.604 15.303-27.444 23.392-58.668 23.392-90.296 0-102.385-83.296-185.682-185.682-185.682h-100.636c-102.386.001-185.682 83.297-185.682 185.682 0 85.339 57.739 159.405 140.412 180.115 4.449 1.115 7.57 5.113 7.57 9.7v48.815l50.021-50.02c1.875-1.875 4.418-2.929 7.071-2.929h81.246c37.801 0 74.172-11.287 105.18-32.64 4.549-3.132 10.776-1.984 13.908 2.564 3.132 4.549 1.984 10.775-2.564 13.908-34.36 23.662-74.653 36.168-116.524 36.168h-77.104l-64.163 64.162c-1.913 1.914-4.471 2.93-7.074 2.93z"></path><path id="XMLID_207_" d="m451.06 364.139c-2.63 0-5.21-1.07-7.07-2.93s-2.93-4.44-2.93-7.07 1.07-5.21 2.93-7.07 4.44-2.93 7.07-2.93 5.21 1.07 7.07 2.93 2.93 4.44 2.93 7.07-1.07 5.21-2.93 7.07c-1.86 1.861-4.44 2.93-7.07 2.93z"></path><path id="XMLID_223_" d="m259.103 212.454h-2.621v-37.845c0-5.523-4.477-10-10-10s-10 4.477-10 10v37.845h-31.298v-37.845c0-5.523-4.477-10-10-10s-10 4.477-10 10v47.845c0 5.523 4.477 10 10 10h41.298v37.951c0 5.523 4.477 10 10 10s10-4.477 10-10v-37.951h2.621c5.523 0 10-4.477 10-10s-4.478-10-10-10z"></path><path id="XMLID_204_" d="m147.435 280.405h-47.898c-4.044 0-7.691-2.437-9.239-6.173s-.692-8.038 2.167-10.898l30.963-30.963c9.032-9.032 14.006-21.04 14.006-33.812 0-7.691-6.258-13.949-13.949-13.949s-13.949 6.257-13.949 13.949c0 5.523-4.477 10-10 10s-10-4.477-10-10c0-18.719 15.229-33.949 33.949-33.949s33.949 15.229 33.949 33.949c0 18.114-7.054 35.145-19.863 47.955l-13.893 13.893h23.756c5.523 0 10 4.477 10 10s-4.476 9.998-9.999 9.998z"></path><path id="XMLID_203_" d="m364.557 280.407c-1.503 0-3.029-.34-4.464-1.058-4.94-2.47-6.942-8.477-4.472-13.417l40.662-81.324h-31.718c-5.523 0-10-4.477-10-10s4.477-10 10-10h47.898c3.466 0 6.685 1.794 8.506 4.743 1.822 2.948 1.988 6.629.438 9.729l-47.898 95.796c-1.752 3.505-5.284 5.531-8.952 5.531z"></path><path id="XMLID_202_" d="m292.34 296.457c-.857 0-1.728-.111-2.595-.343-5.334-1.429-8.5-6.913-7.071-12.248l34.297-128c1.429-5.334 6.913-8.5 12.248-7.071 5.334 1.429 8.5 6.913 7.071 12.248l-34.297 128c-1.197 4.467-5.238 7.414-9.653 7.414z"></path></svg></span>
                <a href="#"><h5 class="u-align-center u-custom-font u-font-lato u-text u-text-6">시험일정<br></a>
                  <br>
                </h5>
              </div>
            </div>
        ...
        <p class="u-align-center u-text u-text-body-alt-color u-text-7">Image from <a href="https://www.freepik.com/photos/people" class="u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-text-body-alt-color u-btn-1">Freepik</a>
        </p>
      </div>
    </section>
    <!-- 
    
    <section class="u-clearfix u-section-2" id="sec-8a41">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-3" src="" data-image-width="256" data-image-height="256" id="sec-a926">
